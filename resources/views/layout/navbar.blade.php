<nav class="sticky top-0 z-50 w-full bg-white border-b border-white">
<header class="flex items-center justify-between py-3 px-6 border-b border-gray-100">
    <div id="header-left" class="flex items-center">
        <div class="text-gray-800 font-semibold">
            <a href="{{route('index')}}" class="text-yellow-500 text-3xl hover:text-yellow-600">&lt;{{config('app.name')}}&gt;</a>
        </div>
        ...
        <div class="flex space-x-5">
            ...
            @auth
                ...
                <div id="dropdownAvatar"
                    class="z-10 hidden bg-gray-600 divide-y divide-yellow-500 rounded-lg shadow w-44">
                    ...
                    <ul class="py-2 text-sm text-gray-200" aria-labelledby="dropdownUserAvatarButton">
                        ...
                        <li>
                            <a href="{{route('admin.index')}}"
                                class="block px-4 py-2 hover:bg-yellow-500 hover:text-white">Admin Dashboard</a>
                        </li>
                        @endcan
                        <li>
                    ...
                    <div class="py-2">
                        <form action="{{ route('logout') }}" method="post" class="block px-4 py-2 text-sm text-gray-200 hover:bg-yellow-500 hover:text-white cursor-pointer">
                            @csrf           
