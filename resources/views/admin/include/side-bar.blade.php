<aside id="logo-sidebar"
    class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 border-right border-gray-200 transition-transform -translate-x-full bg-white border-r border-white sm:translate-x-0"
    aria-label="Sidebar">
        ...
        <ul class="space-y-2 font-medium text-lg">
            ...
            <li>
                <a wire:navigate href="{{ route('admin.categories') }}"
                    ...
                    <div
                    class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-white">
                    <i class="fa-solid fa-layer-group" aria-hidden="true" fill="currentColor"
                        viewBox="0 0 20 18"></i>
                </div>
